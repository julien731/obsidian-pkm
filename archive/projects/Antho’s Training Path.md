...
Resources: Technical Project Manager Training Path (../Second%20Brain/Resources/Technical%20Project%20Manager%20Training%20Path%20a6e82c40e42347dc851ab8b372a84e88.md)
...
- [x]  [What is Agile Software Development? | Agile Alliance](https://www.agilealliance.org/agile101/)
...
- [x]  [What is a Tech Stack? Choosing What Goes In Yours](https://heap.io/topics/what-is-a-tech-stack)
- [x]  [Choosing the Right Tech Stack for Your Project: Basic Principles](https://www.velvetech.com/blog/choosing-project-tech-stack-basic-principles/)
...
There can be a dozen tools that will be needed in various categories:
...
- [x]  [A Guide to Requirements Gathering](https://www.wrike.com/blog/requirements-gathering-guide/#Are-there-best-practices-for-requirement-gathering-techniques)
- [x]  [Product Requirements Management | Definition and Overview](https://www.productplan.com/glossary/product-requirements-management/)
- [x]  [What Is a Product Requirements Document (PRD)?](https://www.productplan.com/glossary/product-requirements-document/)

### Documenting

Documenting features, workflows, logic, and specifications is an important part of the product development process. Writing good documentation requires experience and an organized mind. There are a few things that can be learned to write better technical documentation and to write better in general.
...
<aside>
💡 CI/CD is an essential part of the agile process. It allows for testing an application quickly and often which results in less bugs and surprises after production releases.
...
With this versioning process, it becomes very easy to roll back to an older version in case of a problem.
...
- **Client applications.**
Client applications are apps that don’t have internal business logic and, instead, rely on a server application that provides the necessary logic. Most mobile applications are client applications that rely on a remote server for their business logic and data storage.
- **Server applications.**
...
Version control systems (VCS) are used to keep track of every single change that has been made to an applications’ codebase. It works on the same premise as version history in Word or Google Docs with three massive differences:
...
- VCS allows for collaborative work where each collaborator can incorporate their changes (a process known as “merging”) into the main codebase.
...
- [x]  [What is version control?](https://git-scm.com/video/what-is-version-control)
...
![Untitled](Antho%E2%80%99s%20Training%20Path/Untitled.png)
...
The majority of all applications share a few common components (even if they are implemented in different ways or using different frameworks.)
