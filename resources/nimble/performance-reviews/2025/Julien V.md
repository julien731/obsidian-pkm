...
type: resource
created: 2026-03-10
summary: "360 feedback review for Julien V. from the 2025 review cycle"
tags:
  - performance-review
  - nimble
related:
...
**Strengths:**
- Strong ownership and high standards (3 reviewers) — sets a quality bar that others follow, takes full responsibility for the product he owns
- Supportive and collaborative (3) — trusted partner, empowers engineers, builds trust-based working environment
- Technical depth with product balance (2) — strong technical knowledge without over-indexing on either tech or user needs
- Efficient execution through ambiguity (2) — navigates chaos well, makes timely decisions that keep the team unblocked
- Clear, structured communication (2) — concise, to the point, serves as a model for the team

**Areas for improvement:**
- Requirement depth for complex features (1) — more detailed acceptance criteria and earlier edge case identification would help, especially for junior engineers
- Ownership delegation calibration (1) — gives ownership with good intentions, but sometimes engineers aren't ready for it; needs to read the audience
- Resilience with difficult clients (1) — strengths shine with engaged clients but challenging ones can demotivate; building resilience for tough days
- Sprint preparation (1) — tasks sometimes created during the sprint rather than prepared in the backlog beforehand

## What Went Well

### From Huey

In terms of product vision and direction, he clearly communicated the product goals and kept the team aligned on priorities.

Regarding collaboration with the development team, he was willing to spend time on discussions and made timely decisions that prevented the team from being blocked. Although I am not working with him in the BKK office, he is very approachable whenever I ping him and is always available for clarification when needed.

He built a trust-based working environment, which is reflected in his active participation in discussions and his respect for technical constraints. He aligned with engineering on the feasibility of complex features during the discussion stage, encouraged the team to propose improvements, and made decisions that moved the team forward.

### From Clark

Julien became my role model during my initial phase in the company. He was always open to help, guide and sometimes teach me to help speed up my process when I was just joining. He quickly gave me the confidence to face the client, handle projects and lead teams, to be honest I find him as a source of knowledge when there is something I do not have context about or I need a hand with, I can trust him to hold individual & casual one-on-ones when I just need guidance or advice. Insane team player

### From Vu Tran

- He built a high level of ownership and developed a high standard for the product he owns. This not only helps him deliver high-quality work but also sets a bar for other team members to follow.
- He has strong technical knowledge, which is expected given his experience, and more importantly, he strikes a good balance between technical constraints and users' needs. This helps him avoid over-indexing on either side.
- He executes efficiently and knows how to navigate through ambiguity. This creates a huge positive impact on the team, given the chaos in JFC projects.
- He is super supportive and builds strong collaboration with the entire team. He's a trusted partner.
- His communication style is a model for the team: structured, concise, and to the point.

### From Andy

Despite context switching and blockers in the GT API projects, Julien V supports them well. He joined and helped with JPOS/QMAI integration, JB VN, and JB loyalty research and early implementation. He controls and follows GT projects and collaborates well with the brand team.
...
For complex features or epics, the development team would benefit from more clarity and depth in the requirements. Providing more detailed acceptance criteria and identifying edge cases earlier would help reduce ambiguity and minimize back-and-forth during development. This is especially important for junior engineers — if they follow the story’s AC without critical thinking, some edge cases might be missed.

As a team lead, I often take responsibility for clarifying unclear aspects of the requirements to help the team gain better insight into the assignment and ensure feature alignment across teams.

I understand that the GT mobile team does not publish the app to production, but it would be very helpful if he could share more user data, research insights, or success metrics with the team, client happiness...

Overall, he has had a very positive impact on the teams, not only GT but also the brand apps. I am happy to work with him on future projects (it’s sad that he is leaving GT for a new project).
...
- His strengths shine brightest with engaged clients who bring him motivation. Difficult or unreasonable clients can demotivate him and prevent him from doing his best work. Building resilience when working with challenging clients is an area he can grow in, because not every day is a beautiful day.
