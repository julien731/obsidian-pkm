...
# Engineering Challenges I’m Seeing

- Recruitment
    - Recruitment seems focused exclusively on quality and intricacy instead of ingenuity and practicality. Example from Trung.
        - New hires sometimes feel like working on an actual project is not what’s promised through the recruitment/challenge.
- Team Leads
    - TL is focused on the current sprint and not on the overall project. It's the perception.
    - I think that TL not being an organizational role (i.e., an official title in the company) is a compounding negative factor to delivery.
        - Imo TLs should not rotate.
- Engineering Leads
    - Too much overlap between TL and EL, and nobody really has the responsibility of the project.
    - Engineering is too preoccupied with having a flat structure instead of directly managing. Leads to TL responsible for “delivery” and EL responsible for “successful delivery” (🤔)
- Pushback from Trung and maybe Olivier on TLs understanding of the intent. “You don't listen; it's a misunderstanding”
    - I feel like Andy’s ability to be practical and to deliver according to actual business needs is undervalued.
- Engineering asks for very detailed stories, pushes back when they consider stories not detailed enough (i.e., when every single little thing is listed). On the other hand, the team makes unplanned and non-communicated changes.

[https://app.shortcut.com/ewa-payroll/story/64585/review-the-structure-of-the-code-for-the-sso-1-10-reports-txt-and-pdf](https://app.shortcut.com/ewa-payroll/story/64585/review-the-structure-of-the-code-for-the-sso-1-10-reports-txt-and-pdf)

[https://app.shortcut.com/ewa-payroll/story/63215/backend-as-a-tenant-admin-i-can-download-sso-1-10-as-a-pdf-file-cover-page](https://app.shortcut.com/ewa-payroll/story/63215/backend-as-a-tenant-admin-i-can-download-sso-1-10-as-a-pdf-file-cover-page)
